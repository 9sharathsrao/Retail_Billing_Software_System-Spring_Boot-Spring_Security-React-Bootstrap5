...
const Category = ({categoryName, imgUrl, numberOfItems, bgColor, isSelected, onClick}) => {
    return(
        // Used to render individual categories, so its a reusable component
        //Here we should pass 'categories', which is present in Explore.jsx. Pass it as props in 'DisplayCategory'
        

        //So after accepting the props, now we can style them here
